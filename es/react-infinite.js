...
var Infinite = /*#__PURE__*/function (_React$Component) {
  ...
  function Infinite(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "shouldAttachToBottom", false);
    ...
    _defineProperty(_assertThisInitialized(_this), "generateComputedUtilityFunctions", function (props) {
      var utilities = {};
    ...
    _defineProperty(_assertThisInitialized(_this), "recomputeInternalStateFromProps", function (props) {
      checkProps(props);
    ...
    _defineProperty(_assertThisInitialized(_this), "infiniteHandleScroll", function (e) {
    ...
    _defineProperty(_assertThisInitialized(_this), "manageScrollTimeouts", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "getLowestPossibleScrollTop", function () {
      return _this.state.infiniteComputer.getTotalScrollableHeight() - _this.computedProps.containerHeight;
    });

    _defineProperty(_assertThisInitialized(_this), "hasAllVisibleItems", function () {
      return !(_isFinite(_this.computedProps.infiniteLoadBeginEdgeOffset) && _this.state.infiniteComputer.getTotalScrollableHeight() < _this.computedProps.containerHeight);
    });

    _defineProperty(_assertThisInitialized(_this), "passedEdgeForInfiniteScroll", function (scrollTop) {
      ...
      if (_this.computedProps.displayBottomUpwards) {
        ...
        return scrollTop > _this.state.infiniteComputer.getTotalScrollableHeight() - _this.computedProps.containerHeight - edgeOffset;
      }
    });

    _defineProperty(_assertThisInitialized(_this), "onInfiniteLoad", function () {
      _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_this), "handleScroll", function (scrollTop) {
      _this.shouldAttachToBottom = _this.computedProps.displayBottomUpwards && scrollTop >= _this.getLowestPossibleScrollTop();
  ...
  _createClass(Infinite, [{
    ...
    value: function render() {
      ...
      var loadingSpinner = this.computedProps.infiniteLoadBeginEdgeOffset === undefined ? null : /*#__PURE__*/React.createElement("div", {
        ref: function ref(c) {
      ...
      }), this.computedProps.displayBottomUpwards && loadingSpinner, displayables, !this.computedProps.displayBottomUpwards && loadingSpinner, /*#__PURE__*/React.createElement("div", {
        ref: function ref(c) {
